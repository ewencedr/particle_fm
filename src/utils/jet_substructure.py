...
def dump_hlvs(
    ...
    if plot:
        ...
        axs[0].hist(tau_1s, histtype="step", bins=100)
        axs[0].set_title("tau1")
        axs[1].hist(tau_2s, histtype="step", bins=100)
        axs[1].set_title("tau2")
        axs[2].hist(tau_3s, histtype="step", bins=100)
        axs[2].set_title("tau3")
        axs[3].hist(tau_21s, histtype="step", bins=100)
        axs[3].set_title("tau21")
        axs[4].hist(tau_32s, histtype="step", bins=100)
        axs[4].set_title("tau32")
        axs[5].hist(d12s, histtype="step", bins=100)
        axs[5].set_title("d12")
        axs[6].hist(d23s, histtype="step", bins=100)
        axs[6].set_title("d23")
        axs[7].hist(ecf2s, histtype="step", bins=100)
        axs[7].set_title("ecf2")
        axs[8].hist(ecf3s, histtype="step", bins=100)
        axs[8].set_title("ecf3")
        axs[9].hist(d2s, histtype="step", bins=100)
        axs[9].set_title("d2")
        axs[10].hist(pt, histtype="step", bins=100)
        axs[10].set_title("pt")
        axs[11].hist(mass, histtype="step", bins=100)
        axs[11].set_title("mass")
