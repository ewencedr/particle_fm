...
folder = "/beegfs/desy/user/ewencedr/deep-learning/logs/lhco all jets/runs/2023-08-25_14-42-49"
save_name = "lhco_both_jets"
...
data_x, generation_time_x = generate_data(
    model,
    num_jet_samples=len(mask_x),  # TODO
    batch_size=2048,
...
save_file = join(data_folder, "lhco", "generated", "data", f"{save_file}.h5")
